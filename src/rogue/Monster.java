...
public class Monster extends Persona implements Serializable {
    ...
    static {
        MON_TAB[0] = new Montype("aquator", (ASLEEP | WAKENS | WANDERS | RUSTS), "0d0", 25, 'A', 20, 9, 18, 100, 0, 0);
        MON_TAB[1] = new Montype("bat", (ASLEEP | WANDERS | FLITS | FLIES), "1d3", 10, 'B', 2, 1, 8, 60, 0, 0);
        MON_TAB[2] = new Montype("centaur", (ASLEEP | WANDERS), "3d3/2d5", 32, 'C', 15, 7, 16, 85, 0, 10);
        MON_TAB[3] = new Montype("dragon", (ASLEEP | WAKENS | FLAMES), "4d6/4d9", 145, 'D', 5000, 21, 126, 100, 0, 90);
        MON_TAB[4] = new Montype("emu", (ASLEEP | WAKENS), "1d3", 11, 'E', 2, 1, 7, 65, 0, 0);
        MON_TAB[5] = new Montype("venus fly-trap", (HOLDS | STATIONARY), "5d5", 73, 'F', 91, 12, 126, 80, 0, 0);
        MON_TAB[6] = new Montype("griffin", (ASLEEP | WAKENS | WANDERS | FLIES), "5d5/5d5", 115, 'G', 2000, 20, 126, 85, 0, 10);
        MON_TAB[7] = new Montype("hobgoblin", (ASLEEP | WAKENS | WANDERS), "1d3/1d2", 15, 'H', 3, 1, 10, 67, 0, 0);
        MON_TAB[8] = new Montype("ice monster", (ASLEEP | FREEZES), "0d0", 15, 'I', 5, 2, 11, 68, 0, 0);
        MON_TAB[9] = new Montype("jabberwock", (ASLEEP | WANDERS), "3d10/4d5", 132, 'J', 3000, 21, 126, 100, 0, 0);
        MON_TAB[10] = new Montype("kestrel", (ASLEEP | WAKENS | WANDERS | FLIES), "1d4", 10, 'K', 2, 1, 6, 60, 0, 0);
        MON_TAB[11] = new Montype("leprechaun", (ASLEEP | STEALS_GOLD), "0d0", 25, 'L', 21, 6, 16, 75, 0, 0);
        MON_TAB[12] = new Montype("medusa", (ASLEEP | WAKENS | WANDERS | CONFUSES), "4d4/3d7", 97, 'M', 250, 18, 126, 85, 0, 25);
        MON_TAB[13] = new Montype("nymph", (ASLEEP | STEALS_ITEM), "0d0", 25, 'N', 39, 10, 19, 75, 0, 100);
        MON_TAB[14] = new Montype("orc", (ASLEEP | WANDERS | WAKENS | SEEKS_GOLD), "1d6", 25, 'O', 5, 4, 13, 70, 0, 10);
        MON_TAB[15] = new Montype("phantom", (ASLEEP | INVISIBLE | WANDERS | FLITS), "5d4", 76, 'P', 120, 15, 24, 80, 0, 50);
        MON_TAB[16] = new Montype("quagga", (ASLEEP | WAKENS | WANDERS), "3d5", 30, 'Q', 20, 8, 17, 78, 0, 20);
        MON_TAB[17] = new Montype("rattlesnake", (ASLEEP | WAKENS | WANDERS | STINGS), "2d5", 19, 'R', 10, 3, 12, 70, 0, 0);
        MON_TAB[18] = new Montype("snake", (ASLEEP | WAKENS | WANDERS), "1d3", 8, 'S', 2, 1, 9, 50, 0, 0);
        MON_TAB[19] = new Montype("troll", (ASLEEP | WAKENS | WANDERS), "4d6/1d4", 75, 'T', 125, 13, 22, 75, 0, 33);
        MON_TAB[20] = new Montype("black unicorn", (ASLEEP | WAKENS | WANDERS), "4d10", 90, 'U', 200, 17, 26, 85, 0, 33);
        MON_TAB[21] = new Montype("vampire", (ASLEEP | WAKENS | WANDERS | DRAINS_LIFE), "1d14/1d4", 55, 'V', 350, 19, 126, 85, 0, 18);
        MON_TAB[22] = new Montype("wraith", (ASLEEP | WANDERS | DROPS_LEVEL), "2d8", 45, 'W', 55, 14, 23, 75, 0, 0);
        MON_TAB[23] = new Montype("xeroc", (ASLEEP | IMITATES), "4d6", 42, 'X', 110, 16, 25, 75, 0, 0);
        MON_TAB[24] = new Montype("yeti", (ASLEEP | WANDERS), "3d6", 35, 'Y', 50, 11, 20, 80, 0, 20);
        MON_TAB[25] = new Montype("zombie", (ASLEEP | WAKENS | WANDERS), "1d7", 21, 'Z', 8, 5, 14, 69, 0, 0);
    ...
    void zap_monster(Man man, int kind) {
        switch (kind) {
            ...
            case Id.CANCELLATION:
                ...
                m_flags &= (~(FLIES | FLITS | SPECIAL_HIT | INVISIBLE | FLAMES | IMITATES | CONFUSES | SEEKS_GOLD | HOLDS));
                break;
            case Id.DO_NOTHING:
    ...
    void aim_monster() {
        ...
        for (Item item : level.level_doors) {
            Door dr = (Door) item;
    ...
    int gmc(Man man) {
        if ((!(man.detect_monster || man.see_invisible || man.r_see_invisible) && 0 != (m_flags & INVISIBLE)) || man.blind > 0) {
    ...
    void mv_to(int r, int c) {
        ...
        if (0 != (m_flags & ASLEEP)) {
            ...
            if (0 != (m_flags & WAKENS) && rogue_is_around() && ihate != null && self.rand.percent(ihate.stealthy > 0 ? WAKE_PERCENT / (STEALTH_FACTOR + ihate.stealthy) : WAKE_PERCENT)) {
                wake_up();
            }
    ...
    void set_hated() {
        ...
        while (--j >= 0) {
            Man m = (Man) level.level_men.get(j);
    ...
    void dr_course(boolean entering) {
        ...
        if (entering) {
            ...
            dtab = level.level_doors.toArray(dtab);
    ...
    void mon_hit(Persona man) {
        ...
        int dmg;
        if (0 == (m_flags & STATIONARY)) {
            dmg = Id.getDamage(mt.m_damage, self.rand);
            if (level.cur_level >= AMULET_LEVEL * 2) {
